...
#Determining Day of the Week
    ...
    if sday == 'None':
        if n == 0:
            return (f'{finalhour}:{finalminutes} {finaltimeofday}')
        else:
            return (f'{finalhour}:{finalminutes} {finaltimeofday} ({dayslater})')

#Print Final day of the week when day is specified
    if sday != 'None':
        if n == 0:
            return(f'{finalhour}:{finalminutes} {finaltimeofday}, {finalday}')
        else:
            return (f'{finalhour}:{finalminutes} {finaltimeofday}, {finalday} ({dayslater})')